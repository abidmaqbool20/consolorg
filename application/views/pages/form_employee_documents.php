    ...
    <div class="panel-body"> 
      <form id="common_form" method="post" action="<?= base_url("save") ?>" onsubmit="return save_record(this);" class="form-horizontal" >
        ...
        <div class="form-group">
            ...
            <input type="hidden" name="Table_Name" id="Table_Name" value="files">
            <input type="hidden" name="Org_Id" id="Org_Id" value="<?= $this->org_id; ?>"> 

            
            <div class="col-sm-6 col-xs-12 ">
              <div class="">
                <label class="control-label">Select Files <span class="text-danger">*</span><span class="text-danger error"></span></label>
                <input type="file" class="form-control required" multiple="multiple" placeholder="Files" name="Files[]" id="Files">  
              </div>
            </div>
            <div class="col-sm-6 col-xs-12 "> 
              <div class="">
            ...
            <div class="col-md-12 images_preview"> </div> 
        </div> 
