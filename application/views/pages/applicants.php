...
<div class="mainpanel">
    ...
    <div class="panel" id="assign_interviewers_form"> 
        <div class="panel-body">
            <form method="post"  action="<?= base_url("admin/assign_interviewers"); ?>" id="assign_interviewers_form_id" onsubmit="return assign_interviewers(this)">
                <div class="interviewers row">
                  <div class="col-md-12 int-row">
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12"> 
                        <select class="form-control select2" name="Interviewer" id="Interviewer" >  
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12"> 
                        <select class="form-control select2" name="Interviewer_Category" id="Interviewer_Category" >  
                            <option value="0" selected="selected">Select Interviewer Domain</option>
                            <?php
                    ...
                    <div class="col-md-1"><button type="button"  onclick="add_interviewer_row(this,1)" class="btn btn-default btn-quirk"><i class="fa fa-plus"></i></button> </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-12" style="padding: 5px;"> 
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                      <input type="text" name="Interview_Date" id="Interview_Date" class="form-control" value="<?= date("Y-m-d H:i:s"); ?>">
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12" style="margin: 20px 0px;">
                      <label class="ckbox ckbox-primary">
                          <input type="checkbox" id="Send_Email" name="Send_Email" onclick="show_email_templates(this)"><span>Send Email To Applicants</span>
                      </label>
                    </div>
                  ...
                  <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12" style="margin: 20px 0px;">
                      <label class="ckbox ckbox-primary">
                          <input type="checkbox" id="Send_Interviewer_Email" name="Send_Interviewer_Email" onclick="show_interviewer_email_templates(this)"><span>Send Email To Interviewer</span>
                      </label>
                    </div>
                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 interviewer_email_template"  >
                       <select class="form-control select2" name="Interviewer_Email_Templates" id="Interviewer_Email_Templates"  >
                          <option selected="selected" value="0">Select Email Template</option>
                          <?php 
    ...
    <div class="panel" id="send_email_form"> 
        <div class="panel-body">
            <form method="post"  action="<?= base_url("admin/send_email_to_selected"); ?>" id="Send_Applicant_Email_Form" onsubmit="return send_email_to_selected(this)">
                <div class="col-lg-offset-3 col-md-offset-3 col-sm-offset-3"></div>
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12" style="margin: 20px 0px;">
                     <button class="btn btn-danger btn-quirk" type="button" onclick="cancel_email_form()"><i class="fa fa-times"></i>&nbsp; Cancel </button> 
                     <button class="btn btn-success btn-quirk" type="submit" ><i class="fa fa-check"></i>&nbsp; Submit </button> 
                    </div>
                </div> 
                <div class="col-lg-offset-3 col-md-offset-3 col-sm-offset-3"></div>
            ...
            <div class="row more_filters" style="display: none;">  <br>
              ...
              <div class="col-lg-12 col-md-12 col-sm-12" style="padding: 0; margin-top: 10px;"> 
                  <div class="col-md-2 col-lg-2 col-sm-2 col-xs-12">
                     ...
                     <select class="form-control select2" name="Degree_Type" id="Degree_Type"  >
                        <option value="0" data-select2-id="2">Select Degree Type</option>  
                        <option value="Matriculation/O-Levels" data-select2-id="10">Matriculation/O-Levels</option>
                        <option value="Intermediate/A-Levels" data-select2-id="11">Intermediate/A-Levels</option>
                        <option value="Bachelors 2 Years" data-select2-id="12">Bachelors ( 2 Years )</option>
                        <option value="Bachelors 4 Years" data-select2-id="13">Bachelors ( 4 Years )</option>
                        <option value="Masters" data-select2-id="14">Masters</option>
                        <option value="MS" data-select2-id="15">MS / M-Phil</option>
                        <option value="Doctorate" data-select2-id="16">Doctorate</option>
                        <option value="Certificate" data-select2-id="17">Certificate</option>
                        <option value="Diploma" data-select2-id="18">Diploma</option>
                        <option value="Other" data-select2-id="19">Other</option>
                      </select>
                  </div>
              ...
              <div class="col-lg-12 col-md-12 col-sm-12" style="padding: 0; margin-top: 10px;"> 
                  <div class="col-md-2 col-lg-2 col-sm-2 col-xs-12">
                      ...
                      <select class="form-control select2" name="Applicant_Type" id="Applicant_Type"  >
                        <option value="0" data-select2-id="2">Select Applicant Type</option>  
                        <option value="Not Applied" data-select2-id="10">Not Applied</option>
                        <option value="New" data-select2-id="10">Fresh</option>
                        <option value="Returning" data-select2-id="11">Returning</option> 
                      </select>
                  </div>

                 <div class="col-sm-2  col-xs-12">
                  <div class="">
                    <label class="control-label">From Apply Date <span class="text-danger">*</span><span class="text-danger error"></span></label>
                    <input type="text" class="form-control datepicker" id="From_Apply_Date" name="From_Apply_Date">
                  </div>
                </div>
                <div class="col-sm-2  col-xs-12">
                  <div class="">
                    <label class="control-label">To Apply Date <span class="text-danger">*</span><span class="text-danger error"></span></label>
                    <input type="text" class="form-control datepicker" id="To_Apply_Date" name="To_Apply_Date">
                  </div>
                </div>
              </div> 
            </div> 
            ...
            <table class="table table-bordered nomargin">
              <thead>
                 <tr> 
                  ...
                  <th></th> 
                  <th style="min-width: 350px;">Basic Information</th>  
                  <th>Job Post</th>    
                  <th>Degree Type</th>
                  <th style="width: 200px;">Institute</th>
                  <th>Applied Date</th>
                  <th style="width: 350px;">Applicant Address</th> 
                </tr>
              </thead>
              <tbody id="applicants" class="table_records">
                <?php 
                  ...
                  $this->db->select('
                                ...
                                COUNT(applicant_applications.Applicant_Id) AS applicant_total_applications,
                              ');

                  $this->db->from("applicants"); 
                  $this->db->join("applicant_applications","applicant_applications.Applicant_Id = applicants.Id AND applicant_applications.Org_Id = $this->org_id","left"); 
                  ...
                  $this->db->join('applicant_education', 'applicant_education.Id = (select max(Id) from applicant_education as e2 where e2.Applicant_Id = applicant_education.Applicant_Id ) AND applicant_education.Applicant_Id = applicants.Id AND (applicant_education.Degree_Type=\'Bachelors 4 Years\' OR applicant_education.Degree_Type=\'MS\')', 'left');

                  //$this->db->join("applicant_education","applicant_education.Applicant_Id = applicants.Id AND (applicant_education.Degree_Type='Bachelors 4 Years' OR applicant_education.Degree_Type='MS')","left");
                  ...
                  $this->db->select('
                                ...
                                applicant_education.Marks_Obtained,
                                applicant_education.Degree_Type,
                                applicant_education.Institute_Campus,
                                universities.Name as Institute_Name,
                                COUNT(applicant_applications.Id) AS applicant_total_applications,
                              ');
                ...
                <tr id="row_<?= $value->Id; ?>">
                  ...
                  <td>
                    <span> <?= $value->Job_Title; ?> </span><br>
                    <span class="label label-md2"><?= $value->Location_Name; ?></span>
                  </td>  
...
function show_interviewer_email_templates($this)
{ 
  if($($this).is(":checked"))
  {  
      $(".interviewer_email_template").css("display","block");
      $('.select2').select2();
  }
  else
  {
      $(".interviewer_email_template").css("display","none");
  }
}
...
<script type="text/javascript">
  ...
  $values = 1;
  function add_interviewer_row($this,$value)
  {
    $employees = $ques_cat = "";
    $employees =  "<?php 
                      $options = '<option>Select Interviewer</option>';
                      $employees = $this->db->get_where('employees',array('Deleted'=>0,'Status'=>1,'Org_Id'=>$this->org_id,'Employee_Status'=>'Active'));
                      if($employees->num_rows() > 0)
                      {
                        foreach ($employees->result() as $key => $value) {
    ...
    $ques_cat =  "<?php
                      $options = '<option>Select Interviewer Domain</option>';
                      $question_categories = $this->db->get_where('question_categories',array('Deleted'=>0,'Status'=>1,'Org_Id'=>$this->org_id));
                      if($question_categories->num_rows() > 0)
                      {
                        foreach ($question_categories->result() as $key => $value) {
    ...
    $values = +$value  + 1;
    $(".interviewers").append( '<div class="col-md-12 int-row" id="val_'+$values+'">'+
                                            '<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">'+ 
                                                '<select class="form-control select2" name="Interviewer" id="Interviewer" >'+$employees +'</select>'+ 
                                            '</div>'+
                                            '<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">'+ 
                                                '<select class="form-control select2" name="Interviewer_Category" id="Interviewer_Category" > '+ $ques_cat +'</select>'+ 
                                            '</div>'+
                                            '<div class="col-md-1 col-sm-2 col-xs-3">'+
                                              '<button type="button" onclick="add_interviewer_row(this,'+$values+')" class="btn  btn-default btn-quirk"><i class="fa fa-plus"></i></button>'+
                                              '<button type="button" onclick="delete_interviewer_row(this,'+$values+')" class="btn  btn-default btn-quirk" style="background:#d9534f; color:white;"><i class="fa fa-minus"></i></button>'+
                                            '</div>'+
  ...
  function delete_interviewer_row($this,$id)
  {
    if($id > 1){
      $("#val_"+$id).remove();
      $values = +$values - 1;
