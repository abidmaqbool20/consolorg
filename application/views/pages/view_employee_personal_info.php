...
<?php 
  ...
  $this->db->where(array("employees.Deleted" =>0,"employees.Org_Id"=>$this->org_id,"employees.Id"=>$data));
  $this->db->select('
                employees.*, 
                ...
                employee_education.Institute,
                employee_education.Marks_Obtained,
                employee_education.Degree_Type,
                universities.Name as Institute_Name,
                employee_socialmedia_account.Facebook,
                employee_socialmedia_account.Linkedin,
                employee_socialmedia_account.Twitter,
                employee_socialmedia_account.Instagram,
                employee_socialmedia_account.Youtube,
                applicants.Id as Applicant_Id
              ');

  $this->db->from("employees"); 
  $this->db->join("applicants","applicants.CNIC = employees.CNIC","left"); 
  ...
  $this->db->join("countries","countries.id = employees.Country","left");
  $this->db->join("states","states.id = employees.State","left");
  $this->db->join("cities","cities.id = employees.City","left");
  $this->db->join("countries as per_country","per_country.id = employees.P_Country","left");
  $this->db->join("states as per_states","per_states.id = employees.P_State","left");
  $this->db->join("cities as per_cities","per_cities.id = employees.P_City","left");
  $this->db->join("employee_socialmedia_account","employee_socialmedia_account.Employee_Id = employees.Id","left");

  $this->db->join("employee_education","employee_education.Employee_Id = employees.Id  AND employee_education.Degree_Type='Bachelors ( 4 Year )'","left");
  ...
  if($get_record->num_rows() > 0)
  {
    ...
    {
      $pic_src =  "assets/panel/userassets/employees/".$record_data['Id']."/".$record_data['Photo'];
      if(!file_exists($src))
      {
         $pic_src =  "assets/images/default-user.png";
      } 
    ...
    {
      $src =  "assets/panel/userassets/employees/".$record_data['Id']."/".$record_data['Resume'];
      if(file_exists($src))
      {
        $resume_src = $src;
      } 
    ...
    $get_application_rec = $this->db->get_where("applicant_applications",array("Deleted"=>"0","Status"=>1,"Applicant_Id"=>$record_data['Applicant_Id'],"Org_Id"=>$this->org_id));
                  ...
                  <div class="panel panel-inverse">
                    ...
                    <div class="panel-body view-panle-body">
                     <div class="table-responsive">
                        <table class="table table-bordered table-inverse nomargin view_employee_table">
                    ...
                    <div class="panel-body view-panle-body">
                      <div class="table-responsive">
                        <table class="table table-bordered table-inverse nomargin view_employee_table">
                            ...
                            <tr> 
                              <th colspan="2" style="font-size: 15px;">About employee</th> 
                            </tr>
                            <tr>  
