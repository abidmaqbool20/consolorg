...
<?php
  ...
  if($edit_rec != "")
  {
    $this->db->where(array("applicant_education.Org_Id"=>$this->org_id,"applicant_education.Id"=>$edit_rec));
    $this->db->select("applicant_education.*,universities.Name as Institute_Name,countries.sortname as Country_Code");
    $this->db->from("applicant_education"); 
    $this->db->join("universities","universities.Id = applicant_education.Institute","left");
    $this->db->join("countries","countries.sortname = applicant_education.Country","left");
    ...
    <div class="panel-body"> 
      <form id="common_form" method="post" action="<?= base_url("save") ?>" onsubmit="return save_record(this);" class="form-horizontal" >
        ...
        <div class="form-group">
            ...
            <input type="hidden" name="Table_Name" id="Table_Name" value="applicant_education">
              ...
              <div class="">
                ...
                <select class="form-control select2" id="Degree_Type" name="Degree_Type" value="<?php if(isset($record_data['Degree_Type']) && $record_data['Degree_Type'] != "" ){ echo $record_data['Degree_Type']; } ?>">
                  <option value="0">Select Degree Type</option>   
                    ...
                    <option  <?php if(isset($record_data['Degree_Type'])){ if($record_data['Degree_Type'] == "Bachelors 2 Years"){ echo "selected='selected'"; } } ?>  value="Bachelors 2 Years">Bachelors ( 2 Years )</option> 
                    <option  <?php if(isset($record_data['Degree_Type'])){ if($record_data['Degree_Type'] == "Bachelors 4 Years"){ echo "selected='selected'"; } } ?>  value="Bachelors 4 Years">Bachelors ( 4 Years )</option> 
                        ...
                        <div class="panel-heading" style="padding:0px;">
                            <div class="row">  
                              <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                  <a href="javascript:;" class="btn btn-sm" onclick="load_tab(this,\'form_applicant_education\','.$data.',\'applicant_from_container\', '.$value->Id.')" style=" font-size:18px;float: right; color:#fff;" ><i class="fa fa-pencil"></i></a>
                                  <a href="javascript:;" class="btn btn-sm"  onclick="delete_record(\'applicant_education\','.$value->Id.',this)" style="color: red;float: right; font-size:18px;"> <i class="fa fa-trash"></i></a>
                                </div>
                              </div>
                            </div>
                        </div>
