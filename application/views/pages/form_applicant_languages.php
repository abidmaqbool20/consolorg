...
<?php
  ...
  if($edit_rec != "")
  {
    $this->db->where(array("applicant_languages.Org_Id"=>$this->org_id,"applicant_languages.Id"=>$edit_rec));
    ...
    <div class="panel-body"> 
      <form id="common_form" method="post" action="<?= base_url("save") ?>" onsubmit="return save_record(this);" class="form-horizontal" >
        ...
        <div class="form-group">
            ...
            <input type="hidden" name="Table_Name" id="Table_Name" value="applicant_languages">
                      ...
                      ';
                             ...
                             {  
                               ...
                               echo ' <tr id="row_'.$value->Id.'"> 
                                        ...
                                        <th>
                                          <a href="javascript:;" style="color: blue;" onclick="load_tab(this,\'form_applicant_languages\','.$data.',\'employee_from_container\', '.$value->Id.')" > <i class="fa fa-pencil"></i> </a>&nbsp;&nbsp;
                                          <a href="javascript:;" onclick="delete_record(\'applicant_languages\','.$value->Id.',this)" style="color: red;"> <i class="fa fa-trash"></i></a>
                                        </th> 
                                      </tr>
                                     ';
