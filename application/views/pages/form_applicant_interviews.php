                      ...
                      <div class="panel panel-inverse">
                        ...
                        <div class="panel-body" style="background: #dcdcdc;">
                           <div class="table-responsive">
                              ...
                              foreach ($applicant_interviews->result() as $index => $interview_data) {
                                  ...
                                  echo '<div class="table-responsive" style="margin:10px 0px;" id="row_'.$interview_data->Id.'">
                                          <table class="table table-bordered table-primary nomargin"> 
                                              ...
                                              <tr>  
                                                <th class="interview_table_head">Action</th>
                                                <td>
                                                <a href="javascript:;" class="btn btn-sm" onclick="load_tab(this,\'form_applicant_interviews\','.$data.',\'applicant_from_container\', '.$interview_data->Id.')" style=" font-size:18px;float: right; color:#505b72;" ><i class="fa fa-pencil"></i></a>
                                                <a href="javascript:;" class="btn btn-sm"  onclick="delete_record(\'applicant_interviews\','.$interview_data->Id.',this)" style="color: red;float: right; font-size:18px;"> <i class="fa fa-trash"></i></a>
                                                </td>
                                              </tr>
                                          </table>
                                        </div>';
                              ...
                              foreach ($application_notes->result() as $counter => $notes) {
                               ...
                               echo '<div class="table-responsive" style="margin:10px 0px;" id="row_'.$notes->Id.'">
                                      <div class="alert alert-info"> 
                                        <a href="javascript:;" class="btn btn-sm"  onclick="delete_record(\'application_notes\','.$notes->Id.',this)" style="color: red;float: right; font-size:18px;"> <i class="fa fa-trash"></i></a>
                                        <p>'.$notes->Notes.'</p>
                                      </div>
                                     </div>';
                              }
                            ...
                            echo '<div class="table-responsive" style="margin:10px 0px;text-align: center;">  
                                    <div class="col-md-12">
                                      <button onclick="add_interview('.$value->Job_Id.','.$value->Id.')" class="btn btn-success"><i class="fa fa-plus" aria-hidden="true"></i> Add Interview</button>
                                      <button onclick="add_notes('.$value->Job_Id.','.$value->Id.')" class="btn btn-warning"><i class="fa fa-plus" aria-hidden="true"></i> Add Notes</button>
                                    </div>
                                  </div>';
