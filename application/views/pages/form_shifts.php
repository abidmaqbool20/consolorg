                 ...
                 <?php 
                   ...
                   ?>
                    <div class="col-md-2 col-lg-2 col-sm-4 col-xs-12">
                      <div class="panel panel-profile grid-view" style="background: <?= $selected_color; ?> !important;">
      ...
      <div class="panel">
        <div class="panel-body">
          <div class="">
            ...
            <button style="float: right; margin-left: 5px;" onclick="load_tab(this,'shifts',<?= 0; ?>,'shifts_tabs_body')"  type="reset" class="btn btn-wide btn-danger btn-quirk"><i class="fa fa-times"></i> Cancel</button>
            <button  style="float: right;" onclick="load_tab(this,'form_shifts',<?= 0; ?>,'shifts_tabs_body')" type="reset" class="btn btn-wide btn-default btn-quirk"><i class="fa fa-refresh"></i> Reset</button>
          </div>
        </div>
      </div>
