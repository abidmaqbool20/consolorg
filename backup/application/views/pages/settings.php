    ...
    <div class="row tab-side-wrapper">
        <div class="col-xs-4 col-sm-2 tab-left applicant_tabs">
          ...
          <ul class="nav nav-pills nav-stacked">
            ...
            <li onclick="load_tab(this,'form_work_week_days','','applicant_from_container')" class="active">
              <a href="#javascript:;"><strong>Week Work Days</strong></a>
            </li> 
            <li onclick="load_tab(this,'form_holidays_settings','','applicant_from_container')" >
              <a href="#javascript:;"><strong>Holidays Setting</strong></a>
            </li> 
            <li onclick="load_tab(this,'form_org_email_settings','','applicant_from_container')" >
