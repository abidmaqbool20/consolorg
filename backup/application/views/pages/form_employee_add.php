...
<div class="mainpanel">
  <div class="contentpanel">
    ...
    <form id="common_form" method="post" action="<?= base_url("save_employee") ?>" onsubmit="return save_record(this);" class="form-horizontal" >
      ...
      <div class="panel">
        <div class="panel-body">
          <div class="">
            ...
            <button style="float: right; margin-left: 5px;"  onclick="load_view(this,'employees_table');" type="reset" class="btn btn-wide btn-danger btn-quirk"><i class="fa fa-times"></i> Cancel</button>
            <button  style="float: right;"  onclick="load_view(this,'form_employee_add')" type="reset" class="btn btn-wide btn-default btn-quirk"><i class="fa fa-refresh"></i> Reset</button>
          </div>
        </div>
      </div>
    </form>
