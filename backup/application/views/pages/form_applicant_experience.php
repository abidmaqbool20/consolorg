...
<?php
  ...
  if($edit_rec != "")
  {
    $this->db->where(array("applicant_experience.Org_Id"=>$this->org_id,"applicant_experience.Id"=>$edit_rec));
    ...
    <div class="panel-body"> 
      <form id="common_form" method="post" action="<?= base_url("save") ?>" onsubmit="return save_record(this);" class="form-horizontal" >
        ...
        <div class="form-group">
            ...
            <input type="hidden" name="Table_Name" id="Table_Name" value="applicant_experience">
                        ...
                        <div class="panel-heading" style="padding:0px;">
                            <div class="row">  
                              <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                  <a href="javascript:;" class="btn btn-sm" onclick="load_tab(this,\'form_applicant_experience\','.$data.',\'applicant_from_container\', '.$value->Id.')" style=" font-size:18px;float: right; color:#fff;" ><i class="fa fa-pencil"></i></a>
                                  <a href="javascript:;" class="btn btn-sm"  onclick="delete_record(\'applicant_experience\','.$value->Id.',this)" style="color: red;float: right; font-size:18px;"> <i class="fa fa-trash"></i></a>
                                </div>
                              </div>
                            </div>
                        </div>
