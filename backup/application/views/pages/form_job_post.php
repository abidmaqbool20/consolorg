        ...
        <div class="panel-body nopaddingtop">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6  col-xs-12">
              ...
              <select name="Department_Id" id="Department_Id" value="<?php if(isset($record_data['Department_Id'])){ echo $record_data['Department_Id']; } ?>" class="form-control select2 required">
                <?php 
                  $this->db->order_by("Name","asc");
